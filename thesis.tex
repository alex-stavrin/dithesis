...
They were provided with information detailing the research objectives.

\section{Consent Form}
Next the participants were asked to sign a consent form.

\section{Participant Information Questionnaire}
A questionnaire was given to the participants to gather demographic data.
...
\begin{enumerate}
    ...
    \item \textbf{Years of experience with VR (Virtual Reality)}
    \begin{itemize}
    ...
    \item \textbf{How often are you in VR (Virtual Reality)?}
    \begin{itemize}
    ...
    \item \textbf{How easily do you get motion sickness in VR (Virtual Reality)}
    ...
    \item \textbf{What is your experience level in the tools you mentioned in the last question?}
    \begin{table}[h!]
    \centering
    \small
    \renewcommand{\arraystretch}{1.5}
    ...
    \item \textbf{Have you used a tool for scene creation inside VR (Virtual Reality)? If yes, which ones have you used?}
    \\ Text Input
...
\begin{itemize}
    ...
    \item Use the keyboard to to give the scene a name (move the keyboard around)
    \item Create scene
    \item Rotate around
...
In this section, participants are instructed to build a specific layout: a medieval room featuring a central table surrounded by four chairs.
A timer will be used to measure completion speed for this task.

\subsection{Free Creation}
In this section, participants are tasked with freely decorating the room they created in the previous section,
using any available assets they choose. In this section the recording will be used to count errors, undos and deletes.
