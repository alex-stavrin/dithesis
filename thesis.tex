...
Traditional game engines utilize traditional WIMP (Windows, Icons, Menus, Pointers) interfaces that
...
\begin{figure}[H]
  ...
  \label{unity_desktop_editor}
\end{figure}

The Unity Editor \cite{UnityEngine2024} is the industry standard for XR development, utilizing a \textit{Scene View}.
...
\begin{figure}[H]
  ...
  \label{unreal_desktop_editor}
\end{figure}

Unreal Engine \cite{UnrealEngine2025} represents the high-end of the XR development spectrum, offering robust tools for visual fidelity.
...
Godot Engine \cite{GodotEngine2026} offers a unique perspective on the evolution of immersive tools, as it is the only major engine to have
...
Rec Room \cite{RecRoom2016} represents the most successful implementation of a consumer-facing, VR-native creation system.
...
Arkio \cite{Arkio2026} is a professional-grade collaborative design tool that bridges the gap between traditional architectural modeling and
...
ShapesXR \cite{ShapesXR2026} is an industry-standard prototyping platform designed to facilitate the transition from 2D concepts to 3D spatial interfaces.
...
\begin{enumerate}
  ...
  \item \begin{minipage}[t]{\linewidth}
          \textbf{How easily do you get motion sickness in VR (Virtual Reality)?}
          \begin{center}
            \small
...
\begin{enumerate}
  ...
  \item \begin{minipage}[t]{\linewidth}
          \textbf{I think it is easy to correct errors made during virtual reality experiences.}
          \begin{center}
            \small
            \renewcommand{\arraystretch}{1.5}
            \begin{tabular}{ccccccccc}
...
\begin{enumerate}
  \item \begin{minipage}[t]{\linewidth}
          \textbf{How easy was to transform the assets in the scene?}
          \begin{center}
            \small
            \renewcommand{\arraystretch}{1.5}
